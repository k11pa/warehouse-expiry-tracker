...
with tab2:
    ...
    st.markdown("Вводи последние 6 цифр или полный штрих-код паллета. Поле очистится автоматически.")
                    ...
                    if st.button("✅ Добавить / Обновить", type="primary", use_container_width=True):
                        if not expiration.strip():
                            ...
                            try:
                                ...
                                st.error("Временная ошибка Google. Подожди 30–60 сек и попробуй снова.")
